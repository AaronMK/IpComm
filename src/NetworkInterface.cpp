#include <IpComm/NetworkInterface.h>
...
#	include "private_include/StringConversion.h"
...
namespace IpComm
{
	...
	std::vector<NetworkInterface> NetworkInterface::allInterfaces()
	{
		...
		{
			String FriendlyName = fromWChar(currentInterface->FriendlyName);
	...
	{
		NetworkInterface ret;
		ret.mIpAddr = IpAddress::IpAddress(StringLiteral("127.0.0.1"));
		ret.mName = StringLiteral("<Localhost>");
